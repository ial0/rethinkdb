...
log_serializer_stats_t::log_serializer_stats_t(perfmon_collection_t *parent)
    : serializer_collection(),
      pm_serializer_block_reads(chrono::seconds{1}),
      pm_serializer_index_reads(),
      pm_serializer_block_writes(),
      pm_serializer_index_writes(chrono::seconds{1}),
      pm_serializer_index_writes_size(chrono::seconds{1}, false),
      pm_serializer_read_bytes_per_sec(chrono::seconds{1}),
      pm_serializer_read_bytes_total(),
      pm_serializer_written_bytes_per_sec(chrono::seconds{1}),
