...
public:
    ...
    used vector clocks */
    static versioned_t make_with_manual_timestamp(timespec_t time, const T &value) {
        versioned_t v;
        v.timestamp = time;
    ...
    const timespec_t &get_timestamp() const { return timestamp; }
